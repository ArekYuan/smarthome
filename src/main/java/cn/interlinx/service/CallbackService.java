package cn.interlinx.service;

import java.util.Map;

import cn.interlinx.utils.util.DeviceApi;
import cn.interlinx.utils.util.MpApi;
import cn.interlinx.utils.util.Tools;
import cn.interlinx.utils.consts.MsgType;
import cn.interlinx.utils.consts.XmlResp;
import cn.interlinx.utils.mock.DBMock;
import cn.interlinx.utils.protocol.BlueLight;
		...
		if (MsgType.EVENT.equals(msgType)) {
			...
			if (MsgType.Event.CLICK.equals(event)) {
				...
				if (V1001_LIGHT_ON.equals(eventKey) 
					...
					// 构造设备消息
					BlueLight.CmdId cmdId = open ? BlueLight.CmdId.OPEN_LIGHT_PUSH : BlueLight.CmdId.CLOSE_LIGHT_PUSH;
