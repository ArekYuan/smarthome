...
import cn.interlinx.service.CallbackService;
import cn.interlinx.utils.json.DeviceAuth;
...
//		createQrByDeviceId(deviceId);
		...
		String authKey = "1234567890ABCDEF1234567890ABCD11";//"1234567890ABCDEF1234567890ABCD11";
